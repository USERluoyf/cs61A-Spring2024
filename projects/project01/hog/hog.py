...
def sus_points(score):
    ...
    # BEGIN PROBLEM 4
    "*** YOUR CODE HERE ***"
    if (num_factors(score) - 3) * (num_factors(score) - 4) == 0:
...
def is_always_roll(strategy, goal=GOAL):
    ...
    # BEGIN PROBLEM 7
    "*** YOUR CODE HERE ***"
    num_roll = strategy(0, 0)
    i, j = 0, 0
    while i < goal:
        while j < goal:
            if not num_roll - strategy(i, j) == 0:
                return False
            num_roll = strategy(i, j)
            j += 1
        i += 1
        j = 0
    return True
...
def max_scoring_num_rolls(dice=six_sided, samples_count=1000):
    ...
    # BEGIN PROBLEM 9
    "*** YOUR CODE HERE ***"
    num_rolls, k, score = 1, 1, 0
    while num_rolls <= 10:
        temp = make_averaged(roll_dice, samples_count)(num_rolls, dice)
        if temp > score:
            score = temp
            k = num_rolls
        num_rolls += 1
...
def sus_strategy(score, opponent_score, threshold=11, num_rolls=6):
    ...
    # BEGIN PROBLEM 11
    temp = sus_update(0, score, opponent_score, dice=six_sided) - score
    if temp >= threshold:
        return 0
    else:
        return num_rolls
...
def final_strategy(score, opponent_score):
    ...
    *** YOUR DESCRIPTION HERE ***
    """
    # BEGIN PROBLEM 12
    temp = sus_update(0, score, opponent_score, dice=six_sided)
    k = make_averaged(roll_dice, samples_count=100)(6)
    if temp >= GOAL or (temp - score) >= k:
        return 0
    else:
        return 6
    # END PROBLEM 12
